module.exports = function (app) {
  ...
  app.get('/*/clear-v1', function (req, res) {
    req.session.destroy()
  ...
  app.get('/v1/about-your-health-professionals/another-answer', function(req, res) {
  ...
  app.get('/v1/about-your-health-professionals/q-health-professional-answer', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/supporting-evidence-data', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/supporting-evidence-uploaded-1-data', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/supporting-evidence-uploaded-2-data', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/supporting-evidence-uploaded-3-data', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/uploading-supporting-evidence-1', function(req, res) {
    res.render('v1/supporting-evidence/uploading', { 'file' : 'supporting-evidence-1' });
  });

  app.get('/v1/supporting-evidence/uploading-supporting-evidence-2', function(req, res) {
    res.render('v1/supporting-evidence/uploading', { 'file' : 'supporting-evidence-2' });
  });

  app.get('/v1/supporting-evidence/uploading-supporting-evidence-3', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/upload-cya', function(req, res) {
    res.render('v1/supporting-evidence/upload', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/uploading-cya', function(req, res) {
    res.render('v1/supporting-evidence/uploading', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/uploaded-1-cya', function(req, res) {
    res.render('v1/supporting-evidence/uploaded-1', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/supporting-evidence-cya', function(req, res) {
    res.render('v1/supporting-evidence/supporting-evidence', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/supporting-evidence-data-cya', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/interruption-screen-cya', function(req, res) {
    res.render('v1/supporting-evidence/interruption-screen', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/supporting-evidence-upload-1-cya', function(req, res) {
    res.render('v1/supporting-evidence/supporting-evidence-upload-1', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence-upload-2-cya', function(req, res) {
    res.render('v1/supporting-evidence-upload-2', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/supporting-evidence-upload-3-cya', function(req, res) {
    res.render('v1/supporting-evidence/supporting-evidence-upload-3', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/uploading-supporting-evidence-1-cya', function(req, res) {
    res.render('v1/supporting-evidence/uploading', { 'file' : 'supporting-evidence-1', 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/uploading-supporting-evidence-2-cya', function(req, res) {
    res.render('v1/supporting-evidence/uploading', { 'file' : 'supporting-evidence-2', 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/uploading-supporting-evidence-3-cya', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/supporting-evidence-upload-cya', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/supporting-evidence-uploaded-1-cya', function(req, res) {
    res.render('v1/supporting-evidence/supporting-evidence-uploaded-1', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/supporting-evidence-uploaded-2-cya', function(req, res) {
    res.render('v1/supporting-evidence/supporting-evidence-uploaded-2', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/supporting-evidence-uploaded-3-cya', function(req, res) {
    res.render('v1/supporting-evidence/supporting-evidence-uploaded-3', { 'cya' : 'true' });
  });

  app.get('/v1/supporting-evidence/supporting-evidence-uploaded-1-data-cya', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/supporting-evidence-uploaded-2-data-cya', function(req, res) {
  ...
  app.get('/v1/supporting-evidence/supporting-evidence-uploaded-3-data-cya', function(req, res) {
